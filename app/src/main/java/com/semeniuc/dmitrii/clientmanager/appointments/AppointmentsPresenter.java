 ...
 */
public class AppointmentsPresenter implements AppointmentsContract.Presenter {

    private AppointmentsContract.View appointmentsView;
    ...
    public AppointmentsPresenter(@NonNull AppointmentsContract.View appointmentsView) {
    ...
    @Override
    public void requestCallPhonePermission(String phoneNumber, Context context, Activity activity) {
