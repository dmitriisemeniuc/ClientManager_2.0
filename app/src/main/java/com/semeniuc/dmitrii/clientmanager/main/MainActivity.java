package com.semeniuc.dmitrii.clientmanager.main;
...
public class MainActivity extends BaseActivity
        implements NavigationView.OnNavigationItemSelectedListener, LoginInteractor.OnLogoutListener {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.action_settings) {
            Toast.makeText(this, utils.getMessage(), Toast.LENGTH_LONG).show();
            return true;
        }
